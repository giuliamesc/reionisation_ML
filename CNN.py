...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.average_pooling_3d_6 = nn.AvgPool3d(kernel_size=2)
        ...
        self.average_pooling_3d_7 = nn.AvgPool3d(kernel_size=2)
        ...
        self.average_pooling_3d_8 = nn.AvgPool3d(kernel_size=2)
        ...
        self.average_pooling_3d_15 = nn.AvgPool3d(kernel_size=2)
        ...
        self.average_pooling_3d_16 = nn.AvgPool3d(kernel_size=2)
        ...
        self.average_pooling_3d_17 = nn.AvgPool3d(kernel_size=2)
        
        # CENTRAL BRANCH
        
        #self.concatenate = torch.cat()
        #self.flatten = torch.flatten()
        self.dropout = nn.Dropout3d(p=0.8)
    ...
    def forward(self, x1, x2):
        ...
        out = torch.cat((out1, out2), dim=3) # they are concatenated in the 3th dim, not sure
